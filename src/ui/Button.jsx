...
const base = " font-semibold text-sm tracking-wide uppercase transition-colors duration-300 bg-yellow-400 rounded-full text-stone-800 hover:bg-yellow-300 focus:bg-yellow-300 focus:ring focus:ring-offset-2 focus:ring-yellow-300 focus:outline-none  disabled:cursor-not-allowed"
